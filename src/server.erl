...
-import(mnesia_stuff,[database_run/1, get_types_stats/0, get_agents_list/0,
		 get_number_of_agents_of_type/1, agents_states_write/4,
		  add_absent_nodes_to_mnesia_cluster_from_list/1, save_tables_on_server_disk/1]).
...
%
sys_dbase_save() ->
	save_tables_on_server_disk(node()),
	ok.
%
sys_msg_do_spam() ->
	ok.
